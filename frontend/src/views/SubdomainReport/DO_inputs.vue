<template>
    <div class="bx--tile header top">
        ...
        <div class="buttons">
            ...
            <button
                class="bx--btn bx--btn--danger--primary bx--btn--sm"
                @click="$emit('stepBack')"
                v-if="step === 'Signed' && canStepBack"
            >
                Step Back
                <svg width="13" height="16" viewBox="0 0 13 16" class="bx--btn__icon">
                    <path
